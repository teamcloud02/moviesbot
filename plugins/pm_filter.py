...
async def next_page(bot, query):
    ...
    btn.append([
                InlineKeyboardButton("How To Download ", url=f"https://t.me/teamcloud2/117"),
            ])
    try:
...
async def advantage_spoll_choker(bot, query):
    ...
    if k == False:
        ...
        if files:
            ...
            k = await query.message.edit('This Movie Not Found In DataBase If You Want This Movie Request Us. Request Format - https://t.me/teamcloud2/100')
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('➡️Channel', url='https://t.me/teamcloud2'),
            InlineKeyboardButton('🤖 Updates', url='https://t.me/teamcloud2')
        ], [
        ...
        buttons = [[
            InlineKeyboardButton('♥️ Source', url='https://t.me/teamcloud2')
         ],[
            InlineKeyboardButton('🏠 Home', callback_data='start'),
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.append([
                InlineKeyboardButton("🤔 How To Download ", url=f"https://t.me/teammoviesupdates/127"),
            ])
...
async def advantage_spell_chok(msg):
    ...
    gs_parsed = []
    if not g_s:
        k = await msg.reply("I couldn't find any movie in that name. If You Want That Movie Request Us.Reqyest Format - https://t.me/teamcloud2/100")
